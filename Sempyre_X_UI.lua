...
local SXiOS = Instance.new("ScreenGui") 
...
local SXiosIsOpen = true 

EnableDrag(HDFrame)    

SXiOS.Name = "SXiOS" 
SXiOS.Parent = game.CoreGui 


--- [HDFrame - Frame]
HDFrame.Visible = true
HDFrame.Parent = SXiOS
...
ExecBox.Text = "-- Welcome to Sempyre X!" 
